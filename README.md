...
## 구현 목표
- ESG 보고서 작성을 도울 표준화 프레임워크 개발
  - LLM(GPT API)
- ESG 경영 비용을 마련할 수 있는 장치를 제공
  - DGB 코인 기부를 통한 ESG 지원
- 일반 시민에게 ESG에 대한 접근성을 높임
  - ESG 플랫폼 및 ESG 행사
- 기업이 제공하는 ESG 데이터의 정확성과 신뢰성을 검증
  - 블록체인
...
## 기대효과
- 일반 시민과 기업을 포함한 사회 구성원 모두가 쉽게 ESG에 참여할 수 있는 플랫폼 제공
- ESG가 ESG를 낳는 선순환구조를 통한 사회적 가치 창출
- 사회 전반의 지속 가능한 변화 목표
